...
<html>
	...
	<body>
		...
		<p align="center">
			...
			<input type="text"  style="border:0" name="newcreate" value="新規作成" onclick="p_newcreate()">
			<br><br>
			<input type="text" style="border:0" name="transmit" value="送信箱 " onclick="p_transmition()">
			<br><br>
			<input type="text" style="border:0" name="transmit" value="下書き （<?= $cnt_print_send?> ）" onclick="p_draft()">
		</p>
