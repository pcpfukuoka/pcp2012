	...
	<body>
		...
		<table>
			<tr>
				...
				<td align="center"><input type="text" name="user_id" id="user_id" value="<?= $user_row['user_id'] ?>" disabled="true"></td>
			</tr>

			<tr>
				<td align="center">パスワード：</td>
				<td align="center"><input type="text" name="pass" id="pass" value="<?= $user_row['pass'] ?>" disabled="true"></td>
			</tr>

			<tr>
				<td align="center">ユーザ名</td>
				<td align="center"><input type="text" name="user_name" id="user_name" value="<?= $user_row['user_name'] ?>" disabled="true"></td>
			</tr>

			<tr>
				<td align="center">ふりがな：</td>
				<td align="center"><input type="text" name="user_kana" id="user_kana" value="<?= $user_row['user_kana'] ?>" disabled="true"></td>
			</tr>

			<tr>
				<td align="center">住所：</td>
				<td align="center"><input type="text" name="user_address" id="user_address" value="<?= $user_row['user_address'] ?>" disabled="true"></td>
			</tr>

			<tr>
				<td align="center">電話番号:</td>
				<td align="center"><input type="text" name="user_tel" id="user_tel" value="<?= $user_row['user_tel'] ?>" disabled="true"></td>
			</tr>

			<tr>
				<td align="center">メールアドレス：</td>
				<td align="center"><input type="text" name="user_email" id="user_email" value="<?= $user_row['user_email'] ?>" disabled="true"></td>
			</tr>
		...
		<tr>
			<td>学籍番号※学生のみ</td>
			<td><input type="text" name="student_id" id="student_id" value="<?= $user_row['student_id'] ?>" disabled></td>
		</tr>
	</table>
		...
		<input type = "hidden" name = "regist_flg" value = "1">
