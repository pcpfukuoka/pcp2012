...
$sql = "SELECT attendance.group_seq, attendance.user_seq, date,m_group.group_seq,m_group.group_name AS group_name, m_user.user_name AS user_name, m_student.student_id AS student_id,
		...
		WHERE m_group.group_seq = '$group_seq'
		AND DATE_FORMAT(attendance.date,'%Y-%m') = '$date'
